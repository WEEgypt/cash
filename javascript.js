...
function Print() {
    ...
    doc.document.open();
    doc.document.write("<html><head><title>Cash Details</title><style>body {font-family: monospace;}</style></head><body onload=window.print();setTimeout(window.close(),500);><p>Cash Details:</p>");
